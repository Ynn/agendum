...
export const strings = {
  en: {
    ...
    calendar_days_5: '5 days (Monday-Friday)',
    calendar_days_6: '6 days (Monday-Saturday)',
    calendar_days_7: '7 days (Monday-Sunday)',
    show_qr: 'Show QR',
    scan_qr: 'Scan QR',
  ...
  fr: {
    ...
    theme_light: 'Clair',
    theme_dark: 'Sombre',
    calendar_days: 'Jours affichés',
    calendar_days_5: '5 jours (Lundi-Vendredi)',
    calendar_days_6: '6 jours (Lundi-Samedi)',
    calendar_days_7: '7 jours (Lundi-Dimanche)',
    show_qr: 'Afficher QR',
    scan_qr: 'Scanner QR',
